...
Tags: category, tag, html, terms, woocommerce
...
== Suggestions ==
HTML being stripped out when using the term description function (http://codex.wordpress.org/Function_Reference/term_description) for more referrence.
